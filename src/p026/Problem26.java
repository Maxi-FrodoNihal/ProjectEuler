...
public class Problem26
        implements ICListController<Triple<Integer, Integer, BigDecimal>, Callable<Triple<Integer, Integer, BigDecimal>>>, IProblem {
    ...
    public String solve() {
        ...
        final CList<Triple<Integer, Integer, BigDecimal>, Callable<Triple<Integer, Integer, BigDecimal>>> clist =
                new CList<>(this.threadAmount, Executors.newCachedThreadPool(), this);
