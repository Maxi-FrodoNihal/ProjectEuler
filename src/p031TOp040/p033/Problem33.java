...
public class Problem33 implements IProblem {
    ...
    public String solve() {
                ...
                if (i != j && i < j) {
                    ...
                    for (final String tmpDigit : digitArray) {
                        ...
                        if (z.contains(tmpDigit) && n.contains(tmpDigit)) {
                            ...
                            if (StringUtils.isNotBlank(z) && StringUtils.isNotBlank(n) && "0".equals(z) == false && "0".equals(n) == false) {
        ...
        // lsgSet.stream().forEach(tmpFrac -> System.out.println(tmpFrac + " | " + tmpFrac.reduce()));
