...
class JUnitTest {
   ...
   @Test
   fun testDoor22_01_Level_1() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door22_01_Level_1>()
         .firstOrNull()
         ?.let {door22_01_level_1 ->
            Assertions.assertTrue(
               door22_01_level_1.getSolution() != defaultLsg
                       && door22_01_level_1.solve() == door22_01_level_1.getSolution()
            )
         }?: Assertions.fail()

   @Test
   fun testDoor22_01_Level_2() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door22_01_Level_2>()
         .firstOrNull()
         ?.let {door22_01_level_2 ->
            Assertions.assertTrue(
   ...
   @Test
   fun testDoor22_02_Level_2() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door22_02_Level_2>()
         .firstOrNull()
         ?.let {door22_02_level_2 ->
            Assertions.assertTrue(
   ...
   @Test
   fun testDoor22_04_Level_1() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door22_04_Level_1>()
         .firstOrNull()
         ?.let {door22_04_level_1 ->
            Assertions.assertTrue(
               door22_04_level_1.getSolution() != defaultLsg
                       && door22_04_level_1.solve() == door22_04_level_1.getSolution()
            )
         }?: Assertions.fail()

   @Test
   fun testDoor22_04_Level_2() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door22_04_Level_2>()
         .firstOrNull()
         ?.let {door22_04_level_2 ->
            Assertions.assertTrue(
   ...
   @Test
   fun testDoor24_01_Level_1() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door24_01_Level_1>()
         .firstOrNull()
         ?.let {door24_01_level_1 ->
            Assertions.assertTrue(
               door24_01_level_1.getSolution() != defaultLsg
                       && door24_01_level_1.solve() == door24_01_level_1.getSolution()
            )
         }?: Assertions.fail()

   @Test
   fun testDoor24_01_Level_2() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door24_01_Level_2>()
         .firstOrNull()
         ?.let {door24_01_level_2 ->
            Assertions.assertTrue(
               door24_01_level_2.getSolution() != defaultLsg
                       && door24_01_level_2.solve() == door24_01_level_2.getSolution()
            )
         }?: Assertions.fail()

   @Test
   fun testDoor25_01_Level_1() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door25_01_Level_1>()
         .firstOrNull()
         ?.let {door25_01_level_1 ->
            Assertions.assertTrue(
               door25_01_level_1.getSolution() != defaultLsg
                       && door25_01_level_1.solve() == door25_01_level_1.getSolution()
            )
         }?: Assertions.fail()

   @Test
   fun testDoor25_01_Level_2() =
      DLoader.loadInterfaceObjectsFromT(PathSlave::class.java, IProblem::class.java)
         .filterIsInstance<Door25_01_Level_2>()
         .firstOrNull()
         ?.let {door25_01_level_2 ->
            Assertions.assertTrue(
